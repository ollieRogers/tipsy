...
describe('billBreakDownByPersonSelector', () => {
  ...
  const billBreakdownFilter = billBreakDownByPersonSelector({ bill: { items: [{}] }, serviceCharge: 10 } as StateShape)
  const billBreakdownFilter1 = billBreakDownByPersonSelector({ bill: { items: [billItem1, billItem2] }, serviceCharge: 10 } as StateShape)
  const billBreakdownFilter2 = billBreakDownByPersonSelector({ bill: { items: [assignedBillItem1, billItem2] }, serviceCharge: 10 } as StateShape)
  const billBreakdownFilter3 = billBreakDownByPersonSelector({ bill: { items: [assignedBillItem1, assignedBillItem2, assignedBillItem3] }, serviceCharge: 10 } as StateShape)
